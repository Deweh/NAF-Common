...
namespace Animation
{
	...
	struct Transform
	{
		using extract_func = void(*)(size_t, const RE::NiMatrix3&, const RE::NiPoint3&, void*);
		...
		static void ExtractSoaTransformsReal(const std::span<ozz::math::SoaTransform>& in, const extract_func func, void* userPtr);
		static void ExtractSoaTransformsReal(const std::span<ozz::math::SoaTransform>& in, std::span<RE::NiTransform>& out);
